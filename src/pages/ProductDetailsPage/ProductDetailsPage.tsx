...
export default function ProductDetailsPage() {
  ...
  if (loading) {
    return (
      <div className="product-details-page">
        <div className="product-details-page__content product-details-page__loading">
          Loading...
        </div>
      </div>
    );
  ...
  if (error || !product) {
    return (
      <div className="product-details-page">
        <div className="product-details-page__content product-details-page__error">
      ...
      <div className="product-details-page__content">
        <nav className="product-details-page__breadcrumbs" aria-label="Breadcrumb">
          {breadcrumbs.map((b, i) => (
            <span key={b.label} className="product-details-page__breadcrumb-item">
              {i > 0 && (
                <span className="product-details-page__breadcrumb-sep" aria-hidden>
                  ›
                </span>
              )}
              <Link to={b.path} className="product-details-page__breadcrumb-link">
                {b.label}
              </Link>
            </span>
          ))}
        ...
        <section className="product-details-page__main">
          ...
          <div className="product-details-page__info">
                ...
                <div className="product-details-page__colors">
                  {colors.map((c, i) => (
                    <button
                      key={c}
                      type="button"
                      className={`product-details-page__color ${
                        activeColor === i ? "product-details-page__color--active" : ""
                      }`}
                ...
                <div className="product-details-page__memory">
                  {memoryOptions.map((opt, i) => (
                    <button
                      key={opt}
                      type="button"
                      className={`product-details-page__memory-tab ${
                        activeMemory === i ? "product-details-page__memory-tab--active" : ""
                      }`}
            ...
            <div className="product-details-page__buttons">
              <Button variant="black-stroke" size="default" className="product-details-page__btn">
                Add to Wishlist
              </Button>
              <Button
                variant="fill-small"
                size="default"
                className="product-details-page__btn product-details-page__btn--fill">
                Add to Card
              </Button>
            </div>
            ...
            <div className="product-details-page__features">
              <div className="product-details-page__feature">
                <div className="product-details-page__feature-icon" aria-hidden>
                  🚚
                </div>
                <span>
                  Free Delivery
        ...
        <section className="product-details-page__details-section">
          <div className="product-details-page__details-card">
            ...
            <p className="product-details-page__details-text">
            ...
            <div className="product-details-page__details-specs">
              ...
              {Object.keys(specs).length > 4 && (
                <div
                  className={`product-details-page__details-specs-extra ${
                    detailsExpanded ? "product-details-page__details-specs-extra--open" : ""
                  }`}>
            ...
            {Object.keys(specs).length > 4 && (
              <button
                type="button"
                className={`product-details-page__toggle ${
                  detailsExpanded ? "product-details-page__toggle--open" : ""
                }`}
        ...
        <section className="product-details-page__reviews">
          <div className="product-details-page__reviews-top">
            ...
            <div className="product-details-page__rating-block">
              ...
              <span className="product-details-page__rating-count">
                of {product.reviewsCount} reviews
              </span>
              <div
                className="product-details-page__stars"
              ...
              {["Excellent", "Good", "Average", "Below Average", "Poor"].map((label, i) => (
                <div key={label} className="product-details-page__rating-row">
                  ...
                  <div className="product-details-page__rating-bar-wrap">
                    <div
                      className="product-details-page__rating-bar"
                      style={{ width: i === 0 ? "80%" : i === 1 ? "15%" : "5%" }}
                    />
                  </div>
                  <span className="product-details-page__rating-num">
                    {i === 0 ? 100 : i === 1 ? 20 : 5}
                  </span>
                </div>
              ))}
            ...
            <div className="product-details-page__comment-field">
              <input
                ...
                className="product-details-page__comment-input"
          ...
          <div className="product-details-page__reviews-list">
            {visibleComments.length > 0 ? (
                ...
                <article key={i} className="product-details-page__review">
                  ...
                  <div className="product-details-page__review-content">
                    <div className="product-details-page__review-header">
                      ...
                      <span
                        className="product-details-page__review-stars"
              ...
              <p className="product-details-page__reviews-empty">
            ...
            {hasHiddenComments && (
              <button
                type="button"
                className={`product-details-page__toggle ${
                  reviewsExpanded ? "product-details-page__toggle--open" : ""
                }`}
                onClick={() => setReviewsExpanded(!reviewsExpanded)}>
                {reviewsExpanded
                  ? "View Less"
                  : `View More (${comments.length - VISIBLE_COMMENTS} more)`}
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" aria-hidden>
                  <path
                    d="M6 9l6 6 6-6"
                    stroke="currentColor"
