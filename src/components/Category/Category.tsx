    ...
    <section className="category">
      <div className="category__top">
        ...
        <div className="category__arrows" role="group" aria-label="Category navigation">
          <button type="button" className="category__arrow category__arrow--prev" onClick={() => slide('left')} aria-label="Previous categories">
            <svg width="40" height="32" viewBox="0 0 40 32" fill="none" aria-hidden><path d="M24 8L16 16l8 8" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" /></svg>
          </button>
          <button type="button" className="category__arrow category__arrow--next" onClick={() => slide('right')} aria-label="Next categories">
            <svg width="40" height="32" viewBox="0 0 40 32" fill="none" aria-hidden><path d="M16 8l8 8-8 8" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" /></svg>
          </button>
        </div>
      </div>
