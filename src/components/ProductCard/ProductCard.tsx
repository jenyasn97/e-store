...
export default function ProductCard({ title, price, image, liked = false }: ProductCardProps) {
  return (
    <article className="product-card">
      <div className="product-card__top">
        {liked ? (
          <button type="button" className="product-card__like" aria-label="Unlike">
          ...
          <button type="button" className="product-card__like product-card__like--outline" aria-label="Like">
