...
export default function ProductCard({ id, title, price, oldPrice, image, liked = false, onLikeToggle }: ProductCardProps) {
  ...
  const card = (
    <article className="product-card">
      <div className="product-card__top">
        {liked ? (
          <button type="button" className="product-card__like" aria-label="Unlike" onClick={handleLikeClick}>
          ...
          <button type="button" className="product-card__like product-card__like--outline" aria-label="Like" onClick={handleLikeClick}>
