      ...
      <div className="footer__info">
        ...
        <nav className="footer__nav">
          <div className="footer__section">
            ...
            <a href="/bonus" className="footer__link">
              Bonus program
            </a>
            <a href="/gift-cards" className="footer__link">
              Gift cards
            </a>
            <a href="/credit" className="footer__link">
              Credit and payment
            </a>
            <a href="/contracts" className="footer__link">
              Service contracts
            </a>
            <a href="/non-cash" className="footer__link">
              Non-cash account
            </a>
          ...
          <div className="footer__section">
            ...
            <a href="/find-order" className="footer__link">
              Find an order
            </a>
            <a href="/delivery" className="footer__link">
              Terms of delivery
            </a>
            <a href="/exchange" className="footer__link">
              Exchange and return of goods
            </a>
            <a href="/guarantee" className="footer__link">
              Guarantee
            </a>
